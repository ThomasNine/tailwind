    ...
    <nav className=" bg-white">
      ...
      <div className="container mx-auto px-3 lg:px-0">
        <div className="h-14 flex items-center justify-between">
          <div className="flex justify-start items-center space-x-11">
            <img
            ...
            <form action="">
              <div className="relative">
                ...
                <input
                  type="search"
                  value={search}
                  className=" py-2 pl-10 pr-3 bg-white text-sm 
                   rounded-lg focus:outline-none border-2 focus:border-violet-700 w-32 sm:w-80 md:w-96"
                  placeholder="Search"
                  onChange={(e) => setSearch(e.target.value)}
                />
              </div>
            </form>
            <button className="hidden d-lg-block  relative rounded-full  p-1 text-gray-400 hover:text-gray-500 focus:outline-none focus:ring-2 focus:ring-violet-700 focus:ring-offset-2 focus:ring-offset-white">
          ...
          <button
            className="p-2 rounded-lg text-gray-700 text-2xl lg:hidden"
      ...
      {isOpen && (
        <div className="container mx-auto divide-y divide-gray-100 duration-200">
            ...
            <div className="flex items-center justify-between px-3 py-1">
              <div className="flex items-center">
                ...
                <div className=" px-3">
                  ...
                  <p className=" text-gray-600 text-sm">tom@gmail.com</p>
                </div>
              </div>
              <button className=" relative rounded-full  p-1 mr-3 text-gray-400 hover:text-gray-500 focus:outline-none focus:ring-2 focus:ring-violet-700 focus:ring-offset-2 focus:ring-offset-white">
                <RiNotification3Line className=" h-6 w-6" />
                <span className=" absolute ml-2 -mt-9 bg-violet-600 text-sm text-gray-100 font-semibold px-1 rounded-lg inline-block">
                  10
                </span>
